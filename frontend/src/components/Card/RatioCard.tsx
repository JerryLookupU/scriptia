...
// ============================================
// Placeholder Image Component - 带加载动画
// ============================================
...
const PlaceholderImage: React.FC<PlaceholderImageProps> = ({
  ...
  if (isLoading) {
    return (
      <div
        className="placeholder-img skeleton-loading"
        style={{
          width: '100%',
          height: '100%',
          display: 'flex',
      ...
      <div className="ratio-card-inner">
        ...
        <div className="ratio-card-front">
          ...
          */}
          ...
          {/*
            横图/方图的内容区域（在图片下方）
          */}
          {imageRatio !== '9:16' && imageRatio !== 'none' && (
          ...
          */}
          {imageRatio === 'none' && (
            <div className="content-area-none">
              <div
                className="none-icon"
                style={{
        ...
        <div className="ratio-card-back">
          <div className="back-image-area">
            {data.backImageUrl && !backImageError ? (
              <>
                {!backImageLoaded && (
                  <PlaceholderImage
                    gradient={typeConfig.gradient}
                ...
                <img
                  ...
                  alt={`${data.name} - 背面`}
                  className={backImageLoaded ? 'img-loaded' : 'img-loading'}
                  style={{ width: '100%', height: '100%', objectFit: 'cover' }}
