...
// 无配图专用比例 - none
const noImageNone: CardData = {
  id: 'noimg-4', typeId: 'meme', name: '热梗速递', description: '今日网络流行语速览', tags: ['梗指南'], icon: '🚀', imageRatio: 'none',
};
    ...
    <div className="container">
      ...
      <section className="section">
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 32 }}>
          ...
          {/* 无配图 none */}
          <div>
            <h3 style={{ fontSize: 14, color: '#495057', marginBottom: 12 }}>🚫 无配图 none - 卡片 200×300px，纯图标居中展示</h3>
            <div className="card-showcase">
              <div className="demo-item"><p className="demo-label">梗指南</p><RatioCard data={noImageNone} onDetail={handleDetail} /></div>
            </div>
          </div>
        </div>
      </section>
